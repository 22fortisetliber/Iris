...
import (
	...
	"github.com/22fortisetliber/iris/pkg/util/grpcclient"
	"github.com/22fortisetliber/iris/pkg/util/integration/ca"
	"github.com/22fortisetliber/iris/pkg/util/tls"
)
...
func setupCertificates(t *testing.T) keyMaterial {
	...
	// create client CAs
	testClientCA1 := ca.New("iris Test Client CA 1")
	testClientCA2 := ca.New("iris Test Client CA 2")

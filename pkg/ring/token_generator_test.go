...
func TestMinimizeSpreadTokenGenerator(t *testing.T) {
	...
	// Should fallback to random generator when more than 1 dispatcher does not have tokens and force flag is set
	...
	// Should generate for the dispatcher with with the smaller registered
